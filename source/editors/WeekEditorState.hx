...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat("FVH VHS by Minhdown", 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("fvh_vhs.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("fvh_vhs.ttf");
